...
<body>
	<div class="container">
		<a href="${pageContext.request.contextPath }/home.do" class="btn btn-outline-primary">인덱스</a>
		<a href="${pageContext.request.contextPath }/cafe/private/insert_form.do" class="btn btn-outline-info">새 글 작성</a>
		<h1>글 목록입니다.</h1>
